...
// $TarotCards_update->setCard_key(16);
...
// // $TarotCards_update->updateTarotCards();
...
// // $data = $relation->getShowRelationCardProductsCardAllKey('card_key',2);
// // OutputJson($data);
...
echo "<script>window.location.assign('./view/OAuth/login.php');</script>";
?>

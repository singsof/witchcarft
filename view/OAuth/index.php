...
<body style="background-color: #A9A9A9;">
	...
	<!-- <div id="imageContainer">
		<img id="randomImage" src="./../assets/images/tarotcards/back.png" alt="Random Image">
	</div>
	<button id="showRandomImageBtn">Show Random Image</button>
	<script>
		const imageUrls = [
			'./../assets/images/tarotcards/Screenshot_1.png',
			'./../assets/images/tarotcards/Screenshot_2.png',
			'./../assets/images/tarotcards/Screenshot_3.png',
			'./../assets/images/tarotcards/Screenshot_4.png',
			'./../assets/images/tarotcards/Screenshot_5.png',
			'./../assets/images/tarotcards/Screenshot_6.png',
			'./../assets/images/tarotcards/Screenshot_7.png',
			'./../assets/images/tarotcards/Screenshot_8.png',
			'./../assets/images/tarotcards/Screenshot_9.png',
			'./../assets/images/tarotcards/Screenshot_10.png',

		];

		const imageContainer = document.getElementById('imageContainer');
		const randomImage = document.getElementById('randomImage');
		const showRandomImageBtn = document.getElementById('showRandomImageBtn');

		showRandomImageBtn.addEventListener('click', function() {

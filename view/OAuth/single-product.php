				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<div class="card_area d-flex align-items-center">
							<a class="primary-btn" href="javascript:submitCart()">เพิ่มใส่ตะกร้าสินค้า</a>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="review_box">
								<h4>โพสต์คอมเมนต์</h4>
								<form class="row contact_form" action="javascript:void(0)" method="post" id="contactForm" novalidate="novalidate">
									<input type="hidden" name="account_key" value=''>

...
<head>
    ...
    $Orders = new Orders();
    $OrdersDataAll = $Orders->getSelectOrders(null, PDO::FETCH_OBJ);
    // $OrdersDataAll = $Orders->getShowOrdersAll(sprintf(" account_key = {$_Account->getAccount_id()}"), PDO::FETCH_OBJ);
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($OrdersWait as $key => $value) :
                                ...
                                $accountOr = new Accounts();
                                $accountOr->getShowAccountsOne($value->account_key)
                            ?>
                                <tr class="text-left">
                                    <th scope="row" class="text-center"><?php echo  $detail_i++; ?></th>
                                    <th scope="col"><?php echo $accountOr->getAccount_name() ?></th>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:confirmOrderButton(<?php echo $value->order_key ?>)"><span class="badge badge-pill badge-success ">ยืนยัน</span></a>
